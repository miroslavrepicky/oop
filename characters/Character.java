...
public abstract class Character implements Updatable, Movable, Collidable, Physicable {
    ...
    /**
     * Directly sets HP and armour to the given values, bypassing armour absorption.
     * Used by {@code SaveManager} when restoring a saved game.
     *
     * @param hp    HP value to restore; clamped to [0, maxHp]
     * @param armor armour value to restore; clamped to [0, maxArmor]
     */
