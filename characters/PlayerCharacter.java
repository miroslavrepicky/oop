 ...
 * <p>An attack is initiated via {@link #executeAttack(Attack, Level)}, which:
 * <ol>
...
public abstract class PlayerCharacter extends Character {
     ...
     */
    protected void executeAttack(Attack attack, Level level) {
    ...
    public void performPrimaryAttack(Level level)   { executeAttack(primaryAttack, level); }

    /** Initiates the secondary attack (typically mapped to {@code V}). */
    public void performSecondaryAttack(Level level) { executeAttack(secondaryAttack, level); }
