 ...
 * <p>Every navigation action that requires mutating the game state (reset, revive,
...
public class ShadowQuest extends Game implements AppController {
     ...
     * {@inheritDoc}
     *
     * <p>Implementation: resets all game states via {@link GameManager#resetGame()}
     ...
     *   <li>Initializes the default {@link sk.stuba.fiit.characters.Knight} party.</li>
    ...
    public void startNewGame() {
        ...
        setScreen(new InventoryScreen(this, 1, GameManager.getInstance().getInventory()));
    }

    /**
     * {@inheritDoc}
     *
     * <p>Implementation: loads the save file via {@link SaveManager#load()}.
     * On success, restores the level and switches to {@link GameScreen}.
     * Falls back to a new game if no valid save is found.
     */
    @Override
    ...
    public void goToInventory(int level) {
        setScreen(new InventoryScreen(this, level, GameManager.getInstance().getInventory()));
    }
     ...
     * {@inheritDoc}
     *
     * <p>Implementation: delegates to {@link com.badlogic.gdx.Gdx#app}.
     */
    @Override
    public void exitApp() {
