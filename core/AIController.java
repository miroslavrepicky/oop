...
public class AIController {
    ...
    /** Distance at which the enemy begins attacking. */
    private final float attackRange;

    /**
     * Ideal combat distance – ranged enemies try to maintain this gap and
     * stop approaching once reached. For melee enemies this equals {@code attackRange}.
     */
    ...
    /**
     * Creates a controller with default attack and preferred ranges.
     *
    ...
    /**
     * Resets the patrol boundaries to a 200-unit range centred on the enemy's current position.
     * Called when the enemy loses sight of the player and returns to patrol mode.
     */
